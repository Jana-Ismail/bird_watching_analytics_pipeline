...
def process_inat_data(data, place_id, place_name, start_date, end_date, timestamp, url, total_results):
    ...
    object_name = (f"birds/observations/source=inaturalist/"
                   f"region={CA_REGION_CODE}/hotspot={place_name}/frequency=daily/date={start_date}/{file_name}")
...
def main():
    ...
    start_date = f'2025-09-0{day_number}'
    end_date = start_date
    ...
    if not observations:
        ...
        process_inat_data(observations, place_id, place_name, start_date, end_date, timestamp, url, total_results)
